    ...
    http
      ...
      .authorizeHttpRequests(auth ->
        auth
          ...
          .requestMatchers("/ws/**", "/sockjs/**", "/topic/**", "/app/**")
          .permitAll()
          
          .requestMatchers("/api/v3/api-docs/**")
          .permitAll()

          .requestMatchers(HttpMethod.GET, "/api/chat/popup-room/**").permitAll()
      ...
      protected void doFilterInternal(
        ...
        boolean publicGet =
          ...
          (uri.startsWith("/api/posts") ||
            ...
            uri.startsWith("/api/chat/popup-room") ||
            uri.startsWith("/api/chat/rooms") ||
